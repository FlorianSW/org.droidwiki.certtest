...
public interface CryptUILibrary extends StdCallLibrary {
	...
	CERT_CONTEXT CryptUIDlgSelectCertificateFromStore(HANDLE hCertStore, HANDLE hwnd, WString pwszTitle,
			WString pwszDisplayString, int dwDontUseColumn, int dwFlags, int pvReserved);
}
